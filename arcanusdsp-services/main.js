...
module.exports = function (arcanus) {
    ...
    Plugin.Initialize = function (done) {
        var DarkstarService = require('./services/DarkstarService')(arcanus);
        var NewsService = require('./services/NewsService')(arcanus);

        // Register the services exposed by this plugin..
        arcanus.services.registerService(DarkstarService);
        arcanus.services.registerService(NewsService);
